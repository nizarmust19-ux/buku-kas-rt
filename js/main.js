import { ambilDataKas, simpanDataKasApi, ambilDataPengurus, kirimSaranApi, ambilDataSaran } from './api.js';
...
window.filterDataLaporan = function() {
...
window.kirimDataKas = async function(e) {
    e.preventDefault();
...
window.kirimSaran = async function(e) {
    e.preventDefault();
